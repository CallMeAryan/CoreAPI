...
import net.liven.coreAPI.core.utils.Utils;
...
public interface Message {
    ...
    static void generateConfig(Class<?> clazz, Plugin plugin) {
    ...
    default void sendMessage(Player player, Placeholder... placeholders) {
